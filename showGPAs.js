...
function addGPA(gpaMap){
	...
	for(var i = 2*2; i < tbody.childNodes.length; i+=2){
		// console.log(tbody.childNodes[i].childNodes[17*2 + 1].childNodes[0])
		...
		//2+3 = course ID, but those should remain the same
	}
}
